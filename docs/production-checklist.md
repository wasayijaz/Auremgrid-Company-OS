...
- [ ] Check that `/health` or `/health/detailed` reports schema version 54 for this release line, or the later schema version shipped by the artifact being deployed
