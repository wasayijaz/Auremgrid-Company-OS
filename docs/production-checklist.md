...
- [ ] Check that `/health` or `/health/detailed` reports schema version 65 for this release line, or the later schema version shipped by the artifact being deployed
- [ ] Before production cutover, run a forward-migration rehearsal on a copy of the database and verify `/health/detailed` reports schema version 65 for this release line
