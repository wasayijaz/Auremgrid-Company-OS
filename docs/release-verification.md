...
safety/proactive lifecycle, and injected read-only Stripe Billing/accounting
...
verification must report schema 45 from `/health` or `/health/detailed`.
