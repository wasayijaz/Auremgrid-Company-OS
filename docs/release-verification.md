...
| 20. Tests prove isolation, persistence, permissions, and workflows | 270 offline behavior tests |
| 21. README accurately describes reality | implemented/local fallback/optional/experimental/planned status sections |
| 22. Existing data migrates forward | legacy-v1 migration test and schema 16 migration chain, including durable provider task identity and embedding projection |
