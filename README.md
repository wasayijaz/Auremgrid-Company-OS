...
The Python package is `auremgrid-company-os`; the import surface exports `CompanyOS` from `auremgrid.services.brain`. Schema 66 is the current migration line; `/health/detailed` reports the version of the opened database.
