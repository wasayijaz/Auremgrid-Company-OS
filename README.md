...
| Sales and revenue ops | Prospects, proposals, idempotent proposal-to-client conversion, contract/scope usage, retainer read models, report-pack approvals | Local ledger operations only; no CRM sync or outbound proposal sending is claimed. |
